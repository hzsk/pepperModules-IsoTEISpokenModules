...
public class TEIImporter extends PepperImporterImpl implements PepperImporter {
	...
	public TEIImporter() {
		super();
		this.setName("IsoTEIImporter");
		setSupplierContact(URI.createURI("andre.roehrig@gmail.com"));
		setSupplierHomepage(URI.createURI("https://github.com/korpling/pepperModules-TEIModules"));
		setDesc("Importer for IsoTei");
		this.addSupportedFormat("IsoTEI", "P5 2.6.0", null);
